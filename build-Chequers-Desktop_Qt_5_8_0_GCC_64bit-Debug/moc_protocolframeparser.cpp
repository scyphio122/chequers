...
QT_MOC_LITERAL(6, 97, 11), // "playersList"
QT_MOC_LITERAL(7, 109, 22), // "signalNewGameRequested"
QT_MOC_LITERAL(8, 132, 11), // "std::string"
QT_MOC_LITERAL(9, 144, 10), // "playerName"
QT_MOC_LITERAL(10, 155, 5), // "Parse"
QT_MOC_LITERAL(11, 161, 12) // "receivedData"

    },
    "CProtocolFrameParser\0signalLoginRetval\0"
    "\0success\0signalRegisterRetval\0"
    "signalListOfPlayersReceived\0playersList\0"
    "signalNewGameRequested\0std::string\0"
    "playerName\0Parse\0receivedData"
};
...
void CProtocolFrameParser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->signalListOfPlayersReceived((*reinterpret_cast< QList<QByteArray>(*)>(_a[1]))); break;
        case 3: _t->signalNewGameRequested((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 4: _t->Parse((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CProtocolFrameParser::*_t)(QList<QByteArray> );
...
// SIGNAL 2
void CProtocolFrameParser::signalListOfPlayersReceived(QList<QByteArray> _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
